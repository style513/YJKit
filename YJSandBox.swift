...
@objcMembers
open class YJSandbox: NSObject {
    public static let shared = YJSandbox()
    ...
    public static var cachePath: String {
        return YJSandbox.shared.cachesDirectory + "/" + "SSCache"
    }

    /// 图片缓存路径
    public static var cacheImgPath: String {
        return YJSandbox.shared.cachesDirectory + "/" + "SSCache" + "/" + "Img/"
    }

    /// API缓存路径
    public static var cacheAPIPath: String {
        return YJSandbox.shared.cachesDirectory + "/" + "SSCache" + "/" + "API/"
    }
}
